...
file_handler = RotatingFileHandler(PD_SCRIPT_ROOT_PATH + "/" + logger_application_name + '/'
...
def logger_script():
    latest_logger_file = get_the_latest_file_in_a_folder(PD_SCRIPT_ROOT_PATH + "/" + logger_application_name)
